...
import loginPng from '../../../img/loginPng.svg';
            ...
            <div className="flex justify-center container">
                <div className="mt-4 w-4/5 lg:w-2/5 md:w-1/2">
                    <div data-aos="fade-up" className="bg-white p-4 border-2 rounded-md mb-5">
                        <h4 className="font-bold text-lg text-center text-danger">{newUser ? 'Create an account' : 'Log In here'}</h4>
                        {
                            user.error &&
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div data-aos="fade-down" className="col-left">
                                    <img src={loginPng} alt="" className="login-img" />
                                </div>
                            </div>
